...
// Scaling test: gradually increase VUs to find service limits
// List VU : Detail VU = 3:1 ratio (realistic browsing pattern)
export const options = {
    scenarios: {
        product_list: {
            ...
            startVUs: 0,
            stages: [
                { duration: '30s', target: 50 },   // 50 VU sustained
                { duration: '30s', target: 50 },
                { duration: '30s', target: 100 },  // 100 VU sustained
                { duration: '30s', target: 100 },
                { duration: '30s', target: 200 },  // 200 VU sustained
                { duration: '30s', target: 200 },
                { duration: '30s', target: 300 },  // 300 VU sustained
...
const SORT_TYPES = ['LATEST', 'PRICE_ASC'];
