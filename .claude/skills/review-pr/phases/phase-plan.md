...
### 2. review-summary.md 작성/갱신

프로젝트 루트에 `review-summary.md`를 작성하거나 기존 파일에 새 섹션을 추가한다.

**신규 작성 시 형식:**
```markdown
# PR #{number} AI 리뷰 검토 결과
...
**기존 파일에 추가 시**: 새 라운드 섹션을 `---` 구분선과 함께 파일 하단에 추가한다.

### 3. docs/review-decisions.md 갱신
