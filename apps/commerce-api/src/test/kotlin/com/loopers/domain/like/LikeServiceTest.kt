...
class LikeServiceTest {
    ...
    inner class LikeProduct {
        ...
        @DisplayName("좋아요가 존재하지 않으면, INSERT IGNORE 성공 후 true를 반환한다.")
        @Test
        ...
        @DisplayName("이미 좋아요가 존재하면, INSERT IGNORE가 false를 반환한다.")
        @Test
        fun returnsFalse_whenLikeAlreadyExists() {
            ...
            whenever(likeRepository.save(userId, productId)).thenReturn(false)
