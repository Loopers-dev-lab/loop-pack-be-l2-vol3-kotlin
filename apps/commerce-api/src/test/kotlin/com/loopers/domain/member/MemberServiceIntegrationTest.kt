...
class MemberServiceIntegrationTest @Autowired constructor(
    ...
    inner class Register {
        ...
        @Test
        fun savesWithEncryptedPassword_whenValidRequestIsProvided() {
            // arrange
            ...
            assertAll(
                ...
                { assertThat(result.password).isNotEqualTo(request.password) },
                { assertThat(passwordEncoder.matches(request.password, result.password)).isTrue() },
            )
        }
        ...
        fun throwsConflictException_whenDuplicateLoginIdIsProvided() {
            ...
            val command = MemberRegisterRequest(
                loginId = "testuser01",
    ...
    inner class ChangePassword {
        ...
        fun changesPasswordSuccessfully_whenValidCurrentPasswordAndNewPasswordAreProvided() {
            ...
            // act
            memberService.changePassword(savedMember.loginId, currentPassword, newPassword)
        ...
        fun throwsUnauthorizedException_whenIncorrectCurrentPasswordIsProvided() {
            ...
            // act
            val exception = assertThrows<CoreException> {
                memberService.changePassword(savedMember.loginId, wrongCurrentPassword, newPassword)
            }
