...
class CouponServiceIntegrationTest @Autowired constructor(
    ...
    inner class DeleteCoupon {
        ...
        @DisplayName("존재하는 쿠폰이면, soft delete가 수행되고 조회되지 않는다.")
        @Test
        ...
        @DisplayName("이미 삭제된 쿠폰 ID이면, NOT_FOUND 예외가 발생한다.")
        @Test
