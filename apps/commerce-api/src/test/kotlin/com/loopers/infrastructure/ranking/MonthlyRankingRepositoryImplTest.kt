...
class MonthlyRankingRepositoryImplTest @Autowired constructor(
    ...
    inner class FindAllByPeriodKey {
        ...
        fun `100건 저장 후 정상 반환`() {
            ...
            monthlyRankingJpaRepository.saveAll(entities)

            // Act
            val result = monthlyRankingRepository.findAllByPeriodKey("2026-04")
