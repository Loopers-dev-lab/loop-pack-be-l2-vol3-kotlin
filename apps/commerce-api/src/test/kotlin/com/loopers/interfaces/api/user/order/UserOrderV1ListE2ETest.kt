...
@DisplayName("GET /api/v1/orders - 주문 목록 조회 E2E")
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class UserOrderV1ListE2ETest
@Autowired
constructor(
    ...
    @Nested
    @DisplayName("목록 조회 성공 시")
    inner class WhenGetListSuccess {
        @Test
        @DisplayName("200 OK와 페이징 응답을 반환한다")
        fun getList_success_returns200() {
            // act
        ...
        @Test
        @DisplayName("from/to 미제공 시 기본 1개월 데이터를 반환한다")
        fun getList_noDateParams_returnsDefaultPeriod() {
            // act
            val response = testRestTemplate.exchange(
                ENDPOINT,
                HttpMethod.GET,
