...
@DisplayName("GET /api-admin/v1/orders - Admin 주문 목록 조회 E2E")
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class AdminOrderV1ListE2ETest
@Autowired
constructor(
    ...
    inner class WhenGetListSuccess {
        @Test
        @DisplayName("200 OK와 userId가 포함된 목록을 반환한다")
    ...
    inner class WhenUnauthorized {
        ...
        fun getList_unauthorized_returns401() {
            // act
            val response = testRestTemplate.exchange(
                ENDPOINT,
                HttpMethod.GET,
