...
class BrandFacadeIntegrationTest @Autowired constructor(
    ...
    inner class GetBrand {
        ...
        fun returnsBrand_whenBrandExists() {
            ...
            // act
            val result = brandFacade.getBrand(saved.id)
    ...
    inner class GetAllBrands {
        ...
        fun returnsBrandList_whenBrandsExist() {
            ...
            // act
            val result = brandFacade.getAllBrands(PageRequest.of(0, 20))
    ...
    inner class CreateBrand {
        ...
        fun savesBrandToDatabase_whenValidInfoProvided() {
            ...
            // act
            val result = brandFacade.createBrand(command)
    ...
    inner class UpdateBrand {
        ...
        fun updatesBrandInDatabase_whenValidInfoProvided() {
            ...
            // act
            brandFacade.updateBrand(saved.id, command)
        ...
        fun throwsConflict_whenNameAlreadyExists() {
            ...
            // act & assert
            val exception = assertThrows<CoreException> {
                brandFacade.updateBrand(target.id, command)
            }
            assertThat(exception.errorType).isEqualTo(ErrorType.CONFLICT)
        }
        ...
        fun throwsNotFound_whenBrandNotExists() {
            ...
            // act & assert
            val exception = assertThrows<CoreException> {
                brandFacade.updateBrand(999L, command)
            }
            assertThat(exception.errorType).isEqualTo(ErrorType.NOT_FOUND)
        }
    }
