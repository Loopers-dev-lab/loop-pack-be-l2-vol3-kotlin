...
class PaymentFacade(
    ...
    fun requestPayment(userId: Long, criteria: PaymentCriteria): PaymentInfo {
        val payment = createPaymentInTransaction(userId, criteria)

        return callPgAndUpdatePayment(userId, payment.id, criteria)
    }

    @Transactional
    fun createPaymentInTransaction(userId: Long, criteria: PaymentCriteria): PaymentInfo {
    ...
    @Transactional
    fun callPgAndUpdatePayment(userId: Long, paymentId: Long, criteria: PaymentCriteria): PaymentInfo {
