...
interface LikeV1ApiSpec {
    ...
    fun likeProduct(loginId: String, loginPw: String, productId: Long): ApiResponse<Unit>
    ...
    fun unlikeProduct(loginId: String, loginPw: String, productId: Long): ApiResponse<Unit>

    @Operation(summary = "좋아요 목록 조회", description = "회원의 좋아요 상품 목록을 조회합니다.")
    @ApiResponses(
        value = [
