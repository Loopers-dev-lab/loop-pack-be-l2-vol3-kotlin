...
data class CreateUserRequest(
    ...
    /**
     * Converts this request into a RegisterUserCommand.
     *
     * @return A RegisterUserCommand populated with this request's `loginId`, `password`, `name`, `birthDate`, `email`, and `gender`.
     */
