...
data class ApiResponse<T>(
    ...
    data class Metadata(
        ...
        companion object {
            ...
            fun fail(errorCode: String, errorMessage: String, errors: Map<String, List<String>>) =
                Metadata(Result.FAIL, errorCode, errorMessage, errors)
        }
    }
    ...
    companion object {
        ...
        fun fail(errorCode: String, errorMessage: String, errors: Map<String, List<String>>): ApiResponse<Any?> =
            ApiResponse(
                meta = Metadata.fail(errorCode = errorCode, errorMessage = errorMessage, errors = errors),
                data = null,
            )
    }
}
