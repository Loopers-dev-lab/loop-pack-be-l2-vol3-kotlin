...
interface OrderAdminV1ApiSpec {
    ...
    fun getOrders(ldap: String, page: Int, size: Int): ApiResponse<List<OrderV1Dto.OrderResponse>>

    @Operation(summary = "주문 상세 조회", description = "주문 ID로 주문 상세 정보를 조회합니다.")
    fun getOrderDetail(ldap: String, orderId: Long): ApiResponse<OrderV1Dto.OrderResponse>
}
