...
interface BrandAdminV1ApiSpec {
    ...
    fun createBrand(ldap: String, request: BrandAdminV1Dto.CreateBrandRequest): ApiResponse<BrandAdminV1Dto.BrandResponse>

    @Operation(summary = "브랜드 수정", description = "브랜드 정보를 수정합니다.")
    fun updateBrand(ldap: String, brandId: Long, request: BrandAdminV1Dto.UpdateBrandRequest): ApiResponse<BrandAdminV1Dto.BrandResponse>

    @Operation(summary = "브랜드 삭제", description = "브랜드와 연관된 상품을 모두 삭제합니다.")
    fun deleteBrand(ldap: String, brandId: Long): ApiResponse<Any>
}
