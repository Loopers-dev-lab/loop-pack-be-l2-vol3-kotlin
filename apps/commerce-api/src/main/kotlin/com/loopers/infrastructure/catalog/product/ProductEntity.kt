...
@Table(
    ...
    indexes = [
        ...
        Index(name = "idx_products_active_like_count", columnList = "deleted_at, like_count DESC, id DESC"),
        Index(name = "idx_products_active_created_at", columnList = "deleted_at, created_at DESC, id DESC"),
        Index(name = "idx_products_active_price", columnList = "deleted_at, price ASC, id DESC"),
    ],
)
class ProductEntity(
