...
class WeeklyRankingAggregationJobConfig(
    ...
    companion object {
        ...
        private const val STEP_STAGING = "weeklyStep1Staging"
        private const val STEP_RANK_ASSIGN = "weeklyStep2RankAssign"
    ...
    fun weeklyRankingAggregationJob(): Job {
        return JobBuilder(JOB_NAME, jobRepository)
            ...
            .start(weeklyStep1Staging(null, null))
            .next(weeklyStep2RankAssign())
    ...
    fun weeklyStep1Staging(
        ...
        return StepBuilder(STEP_STAGING, jobRepository)
            ...
            .reader(weeklyMetricReader(startDate, endDate))
            .processor(scoreProcessor)
            .writer(weeklyStagingWriter(null))
    ...
    fun weeklyStep2RankAssign(): Step {
    ...
    @StepScope
    @Bean("weeklyStagingWriter")
    fun weeklyStagingWriter(
