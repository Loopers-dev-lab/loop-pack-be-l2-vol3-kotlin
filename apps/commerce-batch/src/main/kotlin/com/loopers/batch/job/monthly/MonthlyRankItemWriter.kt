...
@Component
class MonthlyRankItemWriter(
    private val jdbcTemplate: JdbcTemplate,
) : ItemWriter<RankedMonthly> {

    override fun write(chunk: Chunk<out RankedMonthly>) {
    ...
    companion object {
        private const val UPSERT_SQL = """
            INSERT INTO mv_product_rank_monthly
              (product_id, yearmonth, view_count, like_count, order_count,
