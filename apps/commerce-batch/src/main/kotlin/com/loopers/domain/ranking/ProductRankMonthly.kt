...
@Table(
    ...
    indexes = [
        Index(name = "idx_mv_monthly_period_rank", columnList = "period_start_date, rank"),
    ],
    uniqueConstraints = [
        UniqueConstraint(name = "uk_mv_monthly_product_period", columnNames = ["product_id", "period_start_date"]),
    ],
)
